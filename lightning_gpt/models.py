...
MINGPT_PRESETS = {
    ...
    '0.7B': dict(n_layer=24, n_head=16, n_embd=1536),
    '1.5B': dict(n_layer=24, n_head=18, n_embd=2304),
    '2.7B': dict(n_layer=24, n_head=24, n_embd=3072),
    '4.8B': dict(n_layer=24, n_head=32, n_embd=4096),
